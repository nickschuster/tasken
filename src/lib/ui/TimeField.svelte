	...
	<div class="flex w-full flex-col gap-1.5">
		...
		<TimeField.Input
			...
			class="flex h-10 w-full items-center rounded-md border border-neutral-300
                bg-white px-2 py-3 text-sm tracking-[0.01em] text-black
                select-none focus-within:border-neutral-400
                focus-within:shadow-sm hover:border-neutral-400
                data-[invalid]:border-red-500 dark:border-neutral-700
